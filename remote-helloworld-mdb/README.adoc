...
==== For model defined queues

----
/subsystem=messaging-activemq/external-jms-queue=myExternalQueue:remove
/subsystem=messaging-activemq/external-jms-queue=myExternalQueueTrue:remove
/subsystem=messaging-activemq/external-jms-queue=myExternalQueueFalse:remove
